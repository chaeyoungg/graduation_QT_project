...
curl -b cookie.txt --header "X-CSRFToken:${csrfToken}" http://ec2-13-209-5-1.ap-northeast-2.compute.amazonaws.com/file/weight/send/ -F 'title='${fileTitle} -F 'weight_file=@./test.tar'
